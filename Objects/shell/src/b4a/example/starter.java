...
public static b4a.example.controlador3 _controlador3 = null;
  public Object[] GetGlobals() {
		return new Object[] {"Controlador1",Debug.moduleToString(b4a.example.controlador1.class),"Controlador2",Debug.moduleToString(b4a.example.controlador2.class),"Controlador3",Debug.moduleToString(b4a.example.controlador3.class),"Conversion",starter.mostCurrent._conversion,"DateUtils",starter.mostCurrent._dateutils,"Main",Debug.moduleToString(b4a.example.main.class),"ModbusService",starter.mostCurrent._modbusservice,"Service",starter.mostCurrent._service};
}
}